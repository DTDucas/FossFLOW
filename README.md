...
Go to <b> --> https://DTDucas.github.io/FossFLOW/ <-- </b>
...
- **📝 [FOSSFLOW_TODO.md](https://github.com/DTDucas/FossFLOW/blob/master/FOSSFLOW_TODO.md)** - Current issues and roadmap with codebase mappings, most gripes are with the isoflow library itself.
- **🤝 [CONTRIBUTORS.md](https://github.com/DTDucas/FossFLOW/blob/master/CONTRIBUTORS.md)** - How to contribute to the project.
...
- **Pre-built Images** - Available at `dtducas/fossflow:latest`
...
docker run -p 80:80 -v $(pwd)/diagrams:/data/diagrams dtducas/fossflow:latest
```
...
```bash
docker run -p 80:80 -e ENABLE_SERVER_STORAGE=false dtducas/fossflow:latest
```
...
git clone https://github.com/DTDucas/FossFLOW
cd FossFLOW
